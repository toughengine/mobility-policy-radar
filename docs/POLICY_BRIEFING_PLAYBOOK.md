...
> **[대체됨 — 2026-09-14]** 이 문서는 Routine 세션이 `GH_PAT`로 저장소를 clone 할 수
> 있다는 전제로 쓰였습니다. 그 전제는 틀렸습니다. 실제로 발화시켜 확인한 결과 그 세션에는
> 저장소 체크아웃도 GitHub 도구도 없습니다. 현행 절차는 **[`ROUTINE_PROMPT.md`](ROUTINE_PROMPT.md)**
> 이며, 그쪽이 실제 트리거에 들어 있는 프롬프트입니다. 이 문서는 왜 그 설계로 가지 않았는지를
> 남겨두기 위해 보관만 합니다.
